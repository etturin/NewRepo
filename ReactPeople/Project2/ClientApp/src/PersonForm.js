        ...
        return (
            <div className='row jumbotron'>
                <div className='col-md-3'>
                    <input value={first} onChange={onTextFirstNameChange} placeholder="First Name" className="form-control"  />
                </div>
                <div className='col-md-3'>
                    <input value={last} onChange={onTextLastNameChange} placeholder="Last Name" className="form-control" />
                </div>
                <div className='col-md-3'>
